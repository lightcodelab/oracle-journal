...
BEGIN
  ...
  PERFORM public.stripe_webhook_fail_event('__p32_evt_b__','live','forced fail');
  v_r := public.stripe_webhook_reserve_event('__p32_evt_b__','x.type','live', now());
  ...
  -- Founder-isolation section — dedicated v_uid2 to avoid leakage w/ Phase 3.1 monotonic test
