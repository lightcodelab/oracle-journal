          ...
          <CardContent className="p-4 space-y-3">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex gap-1">
                <Button size="icon" variant="ghost" onClick={() = aria-label="Move up"> move(i, -1)} disabled={i === 0}><ArrowUp className="w-3.5 h-3.5" /></Button>
                <Button size="icon" variant="ghost" onClick={() = aria-label="Move down"> move(i, 1)} disabled={i === fields.length - 1}><ArrowDown className="w-3.5 h-3.5" /></Button>
                <Button size="icon" variant="ghost" onClick={() = aria-label="Delete"> removeField(f.id)}><Trash2 className="w-3.5 h-3.5" /></Button>
              </div>
            </div>
            <div className="grid sm:grid-cols-3 gap-2">
